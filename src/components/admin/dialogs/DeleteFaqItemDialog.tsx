...
export default function DeleteFaqItemDialog({ item, isOpen, onClose, onSuccess, authToken }: DeleteFaqItemDialogProps) {
    ...
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Are you sure you want to delete the question "{item.question}"?
